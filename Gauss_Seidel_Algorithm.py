...
x, iterations = gauss_seidel_method(matrix, answer, n, max_iterations=100, precision=1e-12, printing=True, print_precision=5)
print(f"Gauss-Seidel Solution: {x} | iterations: {iterations}")
